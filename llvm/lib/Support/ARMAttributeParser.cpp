...
Error ARMAttributeParser::THUMB_ISA_use(AttrType tag) {
  static const char *const strings[] = {"Not Permitted", "Thumb-1", "Thumb-2", "Permitted"};
...
Error ARMAttributeParser::ABI_PCS_RW_data(AttrType tag) {
  static const char *const strings[] = {"Absolute", "PC-relative", "SB-relative",
                                  "Not Permitted"};
...
Error ARMAttributeParser::ABI_PCS_RO_data(AttrType tag) {
  static const char *const strings[] = {"Absolute", "PC-relative", "Not Permitted"};
...
Error ARMAttributeParser::ABI_HardFP_use(AttrType tag) {
  static const char *const strings[] = {"Tag_FP_arch", "Single-Precision", "Reserved",
...
Error ARMAttributeParser::compatibility(AttrType tag) {
  uint64_t const integer = de.getULEB128(cursor);
  StringRef const string = de.getCStrRef(cursor);
...
Error ARMAttributeParser::DIV_use(AttrType tag) {
  static const char *const strings[] = {"If Available", "Not Permitted", "Permitted"};
...
Error ARMAttributeParser::Virtualization_use(AttrType tag) {
  static const char *const strings[] = {"Not Permitted", "TrustZone",
